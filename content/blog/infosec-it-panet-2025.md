+++
title = "Решение задание 2 Первый отборочный этап(ИБ IT-Планета 2025)"
date = 2025-04-07
[taxonomies]
...
также я послу запуска запустил sshd сервис на обоих машинах чтобы легко подключится с одного на другое 
